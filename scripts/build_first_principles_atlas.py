...
CONCEPTS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "failure_mode": "The controller follows the written proxy and produces behavior the designer did not intend.",
    ...
    },
    {
        ...
        "failure_mode": "The method stops at a local stationary point that still violates the real safety or mission goal.",
    ...
    },
    {
        ...
        "why_naive_fails": "Direct search can be large and blind to the state and cost sensitivities already implied by the equations.",
    ...
    },
    {
        ...
        "assumption_boundary": "The optimized model must represent the dynamics and constraints that change the next feasible state.",
    ...
    },
    {
        ...
        "ordinary_problem": "Replanning only protects the system if today's legal move does not leave the controller with no legal move next time.",
    ...
    },
    {
        ...
        "why_naive_fails": "Random changes waste trials and can erase behavior that already reaches the task.",
